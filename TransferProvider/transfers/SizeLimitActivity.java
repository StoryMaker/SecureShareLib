...
import com.android.providers.downloads.R.string;

/**
 * Activity to show dialogs to the user when a transfer exceeds a limit on transfer sizes for
 * mobile networks.  This activity gets started by the background transfer service when a transfer's
...
public class SizeLimitActivity extends Activity
    ...
    private Queue<Intent> mTransfersToShow = new LinkedList<Intent>();
    ...
    private void showNextDialog() {
        ...
        if (mTransfersToShow.isEmpty()) {
            finish();
            return;
        }

        mCurrentIntent = mTransfersToShow.poll();
    ...
    public void onClick(DialogInterface dialog, int which) {
        ...
        if (isRequired && which == AlertDialog.BUTTON_NEGATIVE) {
            ...
            values.put(Transfers.Impl.COLUMN_BYPASS_RECOMMENDED_SIZE_LIMIT, true);
