...
public class Helpers {
     ...
     * transfered to the file system. We only support the attachment type.
     */
    ...
    private static String chooseFilename(String url, String hint, String contentDisposition,
        ...
        // The VFAT file system is assumed as target for transfers.
    ...
    private static String chooseUniqueFilenameLocked(int destination, String filename,
        ...
        */
        ...
        throw new StopRequestException(Downloads.Impl.STATUS_FILE_ERROR,
                "failed to generate an unused filename on internal transfer storage");
    }

    /**
     * Checks whether the filename looks legitimate
     */
    static boolean isFilenameValid(String filename, File transfersDataDir) {
        final String[] whitelist;
        try {
            filename = new File(filename).getCanonicalPath();
            whitelist = new String[] {
                    transfersDataDir.getCanonicalPath(),
