...
import static com.android.providers.transfers.Constants.LOGV;
...
/**
 * Manages asynchronous scanning of completed transfers.
 */
public class TransferScanner implements MediaScannerConnectionClient {
    ...
    public TransferScanner(Context context) {
        mContext = context;
    ...
    /**
     * Request that given {@link TransferInfo} be scanned at some point in
     * future. Enqueues the request to be scanned asynchronously.
     *
     * @see #hasPendingScans()
     */
    public void requestScan(TransferInfo info) {
