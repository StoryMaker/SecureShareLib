 ...
 * contents.
 */
public class TransferStorageProvider extends DocumentsProvider {
    ...
    static void onTransferProviderDelete(Context context, long id) {
    ...
    public String createDocument(String docId, String mimeType, String displayName)
        ...
        try {
            ...
            return Long.toString(mDm.addCompletedDownloadTransfer(
