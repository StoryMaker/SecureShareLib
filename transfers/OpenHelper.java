...
public class OpenHelper {
    /**
     * Build and start an {@link Intent} to view the transfer with given ID,
    ...
    /**
     * Build an {@link Intent} to view the transfer with given ID, handling
    ...
    private static Intent buildViewIntent(Context context, long id) {
        ...
        final Cursor cursor = downloadManager.query(new DownloadManager.Query().setFilterById(id));
        try {
            ...
            mimeType = TransferDrmHelper.getOriginalMimeType(context, file, mimeType);
