...
import io.scal.secureshareui.login.SMLoginActivity;
import io.scal.secureshareui.model.Account;
import io.scal.secureshareuilibrary.R;

public class SMSiteController extends SiteController {
    private static final String TAG = "SMSiteController";
    public static final String SITE_NAME = "StoryMakerOAuth";
    public static final String SITE_KEY = "storymakeroauth";
    ...
    public SMSiteController(Context context, Handler handler, String jobId) {
        super(context, handler, jobId);
        key = mContext.getString(R.string.sm_key);
        secret = mContext.getString(R.string.sm_secret);
    }
    ...
    private void uploadFile(String title, String desc, String body, String credentials, String useTor) {
        ...
        final SMWrapper wrapper = new SMWrapper(key, secret, credentials);
