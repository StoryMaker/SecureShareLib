...
AWS_SERVICES_FILENAME="aws-android-sdk-2.0.5-s3.jar"
AWS_SERVICES_TEMP_DIR="aws-android-sdk-2.0.5-s3-temp"
AWS_SERVICES_STRIP_FILE="strip_s3.conf"
AWS_SERVICES_NESTED_PATH="com/amazonaws/services/s3"
AWS_SERVICES_OUTPUT_FILE="aws-android-sdk-2.0.5-s3-STRIPPED.jar"
